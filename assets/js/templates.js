...
(function () {
  ...
  T.t1 = {
    ...
    fonts: ["Be+Vietnam+Pro:wght@400;500;600;700;800;900"],
    css: "\
.tpl.t1{--ink:#18160F;--cream:#FAF8F3;--card:#FEFDFB;--navy:#0F1E2E;--muted:#68644F;--line:#E7E2D5;--acc:#B85C2E;--acc2:#CF7C4B;font-family:'Be Vietnam Pro',sans-serif;color:var(--ink);background:#fff}\
...
.tpl.t1 .svc{background:var(--card);padding:30px 24px;min-height:190px}.tpl.t1 .svc-num{font-family:monospace;color:#B3AC96;font-weight:700;margin-bottom:14px}\
...
.tpl.t1 .why{display:flex;gap:16px}.tpl.t1 .why-num{font-family:monospace;font-size:44px;font-weight:800;color:var(--acc);line-height:1}\
...
.tpl.t1 .proc{border-left:2px solid rgba(255,255,255,.16);padding-left:20px}.tpl.t1 .proc-num{font-family:monospace;font-size:44px;font-weight:900;color:var(--acc2);opacity:.6;margin-bottom:12px}\
...
.tpl.t1 .style{background:#fff;border:1px solid var(--line);border-radius:14px;padding:28px}.tpl.t1 .style-num{color:var(--acc);font-weight:700;font-family:monospace;margin-bottom:10px}\
...
@media(max-width:820px){.tpl.t1 .about-grid,.tpl.t1 .contact-wrap{grid-template-columns:1fr}.tpl.t1 .about-media{display:none}}",
  ...
  T.t2 = {
    ...
    fonts: ["Cormorant+Garamond:wght@500;600;700", "Inter:wght@400;500;600;700"],
    css: "\
.tpl.t2{--bg:#0B0B0D;--pane:#141418;--gold:#C9A24B;--gold2:#E4C578;--tx:#EAE7E1;--mut:#9A968C;--line:#26262C;font-family:'Inter',sans-serif;color:var(--tx);background:var(--bg)}\
...
.tpl.t2 .logo{height:38px}.tpl.t2[data-loginv='1'] .logo{filter:brightness(0) invert(1)}.tpl.t2 .logo-txt{font-family:'Cormorant Garamond',serif;font-size:26px;font-weight:700;letter-spacing:.04em;color:var(--gold2)}\
...
.tpl.t2 .hero h1{font-family:'Cormorant Garamond',serif;font-weight:600;font-size:clamp(40px,7vw,84px);line-height:1.02;margin:0 0 20px}\
...
.tpl.t2 .stat-n{font-family:'Cormorant Garamond',serif;font-size:clamp(30px,4vw,46px);color:var(--gold2);line-height:1}.tpl.t2 .stat-l{font-size:11.5px;letter-spacing:.1em;text-transform:uppercase;color:var(--mut);margin-top:8px}\
...
.tpl.t2 .sec-title{font-family:'Cormorant Garamond',serif;font-weight:600;font-size:clamp(30px,4.4vw,52px);margin:0 0 40px}\
...
.tpl.t2 .svc-num{font-family:'Cormorant Garamond',serif;color:var(--gold);font-size:28px;margin-bottom:16px}\
.tpl.t2 .svc-title{font-family:'Cormorant Garamond',serif;font-size:23px;font-weight:600;margin:0 0 10px}.tpl.t2 .svc-desc{font-size:13.5px;line-height:1.7;color:var(--mut);margin:0}\
...
.tpl.t2 .why{background:var(--bg);padding:30px 26px;display:flex;gap:16px}.tpl.t2 .why-num{color:var(--gold);font-family:'Cormorant Garamond',serif;font-size:26px}\
...
.tpl.t2 .proc-num{font-family:'Cormorant Garamond',serif;color:var(--gold);font-size:40px;border-bottom:1px solid var(--line);padding-bottom:12px;margin-bottom:14px}\
...
.tpl.t2 .proj-body{padding:20px 22px}.tpl.t2 .proj-title{font-family:'Cormorant Garamond',serif;font-size:22px;font-weight:600;margin:0 0 5px}.tpl.t2 .proj-meta{font-size:12.5px;color:var(--mut);margin:0}\
...
.tpl.t2 .style-name{font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:600;margin:0 0 8px}.tpl.t2 .style-desc{font-size:13px;line-height:1.7;color:var(--mut);margin:0}\
...
.tpl.t2 .c-label{color:var(--gold);letter-spacing:.14em;font-size:11px;margin-bottom:4px}.tpl.t2 .c-item{margin-bottom:18px}.tpl.t2 .c-phone a{font-family:'Cormorant Garamond',serif;font-size:22px;color:var(--gold2)}\
...
.tpl.t2 .contact-form h3{font-family:'Cormorant Garamond',serif;font-size:26px;font-weight:600;margin:0 0 6px}\
...
@media(max-width:820px){.tpl.t2 .about-grid,.tpl.t2 .contact-wrap{grid-template-columns:1fr}.tpl.t2 .about-media{display:none}}",
  ...
  T.t3 = {
    ...
    fonts: ["Inter:wght@300;400;500;600;700", "Space+Mono:wght@400;700"],
    css: "\
.tpl.t3{--tx:#111;--mut:#888;--line:#EAEAEA;--acc:#111;font-family:'Inter',sans-serif;color:var(--tx);background:#fff;font-weight:400}\
...
.tpl.t3 .head-right{display:flex;gap:22px;align-items:center;font-family:'Space Mono',monospace;font-size:12px}.tpl.t3 .back{color:var(--mut)}\
...
.tpl.t3 .hero-badge{font-family:'Space Mono',monospace;font-size:12px;color:var(--mut);letter-spacing:.02em;display:block;margin-bottom:28px}\
...
.tpl.t3 .stat-n{font-size:clamp(26px,3vw,38px);font-weight:300;letter-spacing:-.02em}.tpl.t3 .stat-l{font-family:'Space Mono',monospace;font-size:11.5px;color:var(--mut);margin-top:8px}\
.tpl.t3 .sec{max-width:1100px;margin:0 auto;padding:clamp(60px,10vw,120px) clamp(20px,5vw,64px)}\
.tpl.t3 .eyebrow{font-family:'Space Mono',monospace;font-size:12px;color:var(--mut);margin-bottom:20px}\
...
.tpl.t3 .svc-num,.tpl.t3 .why-num,.tpl.t3 .proc-num{font-family:'Space Mono',monospace;color:var(--mut);font-size:13px}\
...
.tpl.t3 .proj-badge{position:absolute;bottom:12px;left:12px;background:#fff;font-family:'Space Mono',monospace;font-size:10.5px;padding:4px 10px}\
.tpl.t3 .proj-body{padding:14px 2px}.tpl.t3 .proj-title{font-size:16px;font-weight:400;margin:0 0 4px}.tpl.t3 .proj-meta{font-family:'Space Mono',monospace;font-size:11.5px;color:var(--mut);margin:0}\
.tpl.t3 .style-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:40px}\
.tpl.t3 .style-num{font-family:'Space Mono',monospace;color:var(--mut);font-size:12px;margin-bottom:12px}.tpl.t3 .style-name{font-size:20px;font-weight:400;margin:0 0 10px}.tpl.t3 .style-desc{font-size:14px;font-weight:300;line-height:1.75;color:var(--mut);margin:0}\
...
.tpl.t3 .c-label{font-family:'Space Mono',monospace;font-size:11px;color:var(--mut);margin-bottom:4px}.tpl.t3 .c-item{margin-bottom:20px}.tpl.t3 .c-phone a{font-size:20px;font-weight:300}\
.tpl.t3 .c-social{display:flex;gap:20px;margin-top:24px;font-family:'Space Mono',monospace;font-size:12px}\
...
.tpl.t3 .site-foot{border-top:1px solid var(--line);padding:36px clamp(20px,5vw,64px);display:flex;justify-content:space-between;flex-wrap:wrap;gap:14px;font-family:'Space Mono',monospace;font-size:12px;color:var(--mut)}\
@media(max-width:760px){.tpl.t3 .about-grid,.tpl.t3 .contact-wrap{grid-template-columns:1fr;gap:36px}.tpl.t3 .svc,.tpl.t3 .why,.tpl.t3 .proc{grid-template-columns:50px 1fr;gap:14px}}",
  ...
  T.t4 = {
    ...
    fonts: ["Archivo:wght@400;500;600;700;800;900", "Archivo+Black"],
    css: "\
.tpl.t4{--tx:#0E0E0E;--bg:#F4F1EC;--red:#E63325;--mut:#6b6b6b;--line:#d9d5cc;font-family:'Archivo',sans-serif;color:var(--tx);background:var(--bg)}\
...
.tpl.t4 .logo{height:38px}.tpl.t4[data-loginv='1'] .logo{filter:brightness(0)}.tpl.t4 .logo-txt{font-family:'Archivo Black',sans-serif;font-size:22px;text-transform:uppercase;letter-spacing:-.02em}\
...
.tpl.t4 .hero h1{font-family:'Archivo Black',sans-serif;font-size:clamp(48px,11vw,150px);line-height:.92;letter-spacing:-.04em;text-transform:uppercase;margin:0}\
...
.tpl.t4 .stat-n{font-family:'Archivo Black',sans-serif;font-size:clamp(28px,3.5vw,44px);line-height:1}.tpl.t4 .stat-l{font-size:12px;font-weight:600;text-transform:uppercase;color:var(--mut);margin-top:8px}\
...
.tpl.t4 .sec-title{font-family:'Archivo Black',sans-serif;font-size:clamp(30px,5vw,64px);text-transform:uppercase;letter-spacing:-.03em;line-height:.98;margin:0 0 40px}\
...
.tpl.t4 .svc-num{font-family:'Archivo Black',sans-serif;font-size:34px;color:var(--red);margin-bottom:12px}.tpl.t4 .svc-title{font-size:19px;font-weight:700;text-transform:uppercase;margin:0 0 10px}.tpl.t4 .svc-desc{font-size:14px;line-height:1.6;color:var(--mut);margin:0}\
.tpl.t4 .why-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:28px}\
.tpl.t4 .why{padding-top:20px;border-top:3px solid var(--red)}.tpl.t4 .why-num{font-family:'Archivo Black',sans-serif;font-size:15px;margin-bottom:10px}.tpl.t4 .why-title{font-size:17px;font-weight:700;margin:0 0 8px;text-transform:uppercase}.tpl.t4 .why-desc{font-size:14px;line-height:1.6;color:var(--mut);margin:0}\
.tpl.t4 .proc-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:0;border-top:2px solid var(--tx)}\
.tpl.t4 .proc{padding:28px 22px;border-bottom:2px solid var(--tx)}.tpl.t4 .proc-num{font-family:'Archivo Black',sans-serif;font-size:40px;-webkit-text-stroke:2px var(--tx);color:transparent;margin-bottom:12px}.tpl.t4 .proc-title{font-size:16px;font-weight:700;text-transform:uppercase;margin:0 0 6px}.tpl.t4 .proc-desc{font-size:13.5px;line-height:1.6;color:var(--mut);margin:0}\
...
.tpl.t4 .contact-lead{font-size:16px;line-height:1.7;margin:0 0 26px}.tpl.t4 .c-label{color:var(--red);font-weight:700;font-size:12px;text-transform:uppercase;margin-bottom:4px}.tpl.t4 .c-item{margin-bottom:16px}.tpl.t4 .c-phone a{font-family:'Archivo Black',sans-serif;font-size:22px}\
...
.tpl.t4 .contact-form h3{font-family:'Archivo Black',sans-serif;text-transform:uppercase;font-size:20px;margin:0 0 6px}\
...
@media(max-width:820px){.tpl.t4 .about-grid,.tpl.t4 .contact-wrap{grid-template-columns:1fr}.tpl.t4 .about-media{border-left:0;border-top:2px solid var(--tx)}}",
  ...
  T.t5 = {
    ...
    fonts: ["Fraunces:opsz,wght@9..144,400;9..144,500;9..144,600;9..144,700", "Inter:wght@400;500;600"],
    css: "\
.tpl.t5{--grn:#1F3D30;--grn2:#2F5A46;--sand:#EDE7D7;--cream:#F6F2E9;--tx:#22271F;--mut:#5f6b5c;--acc:#B98A3E;--line:#dcd6c6;font-family:'Inter',sans-serif;color:var(--tx);background:var(--cream)}\
...
.tpl.t5 .logo{height:40px}.tpl.t5[data-loginv='1'] .logo{filter:brightness(0)}.tpl.t5 .logo-txt{font-family:'Fraunces',serif;font-size:24px;font-weight:600;color:var(--grn)}\
...
.tpl.t5 .hero h1{font-family:'Fraunces',serif;font-weight:500;font-size:clamp(38px,6vw,72px);line-height:1.05;margin:0 0 16px;max-width:760px}\
...
.tpl.t5 .stat-n{font-family:'Fraunces',serif;font-size:clamp(24px,3.2vw,36px);font-weight:500}.tpl.t5 .stat-l{font-size:12.5px;color:rgba(255,255,255,.82);margin-top:6px}\
...
.tpl.t5 .sec-title{font-family:'Fraunces',serif;font-weight:500;font-size:clamp(27px,3.6vw,44px);margin:0 0 38px}\
...
.tpl.t5 .svc{background:var(--sand);border-radius:18px;padding:30px 26px}.tpl.t5 .svc-num{font-family:'Fraunces',serif;color:var(--grn2);font-size:26px;margin-bottom:12px}.tpl.t5 .svc-title{font-family:'Fraunces',serif;font-size:20px;font-weight:600;margin:0 0 10px}.tpl.t5 .svc-desc{font-size:14px;line-height:1.65;color:var(--mut);margin:0}\
.tpl.t5 .why-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(270px,1fr));gap:28px 36px}\
.tpl.t5 .why{display:flex;gap:16px}.tpl.t5 .why-num{font-family:'Fraunces',serif;color:var(--acc);font-size:34px;line-height:1}.tpl.t5 .why-title{font-size:16px;margin:0 0 6px}.tpl.t5 .why-desc{font-size:14px;line-height:1.6;color:var(--mut);margin:0}\
...
.tpl.t5 .proc{background:var(--cream);border-radius:16px;padding:26px 22px}.tpl.t5 .proc-num{font-family:'Fraunces',serif;color:var(--grn);font-size:36px;margin-bottom:10px}.tpl.t5 .proc-title{font-size:16px;margin:0 0 6px}.tpl.t5 .proc-desc{font-size:13.5px;line-height:1.6;color:var(--mut);margin:0}\
...
.tpl.t5 .proj-body{padding:18px 20px}.tpl.t5 .proj-title{font-family:'Fraunces',serif;font-size:18px;font-weight:600;margin:0 0 5px}.tpl.t5 .proj-meta{font-size:13px;color:var(--mut);margin:0}\
.tpl.t5 .style-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:20px}.tpl.t5 .style{background:var(--sand);border-radius:18px;padding:28px}.tpl.t5 .style-num{color:var(--acc);font-family:'Fraunces',serif;font-size:22px;margin-bottom:8px}.tpl.t5 .style-name{font-family:'Fraunces',serif;font-size:19px;font-weight:600;margin:0 0 8px}.tpl.t5 .style-desc{font-size:13.5px;line-height:1.7;color:var(--mut);margin:0}\
...
.tpl.t5 .c-label{color:#d8b877;font-size:11.5px;letter-spacing:.06em;margin-bottom:3px}.tpl.t5 .c-item{margin-bottom:16px}.tpl.t5 .c-phone a{font-family:'Fraunces',serif;font-size:21px}\
.tpl.t5 .c-social{display:flex;gap:16px;margin-top:20px;color:#d8b877;font-size:13.5px}\
.tpl.t5 .contact-form{background:var(--cream);color:var(--tx);border-radius:18px;padding:30px;display:flex;flex-direction:column;gap:12px}.tpl.t5 .contact-form h3{font-family:'Fraunces',serif;font-size:21px;font-weight:600;margin:0 0 6px}\
...
@media(max-width:820px){.tpl.t5 .about-grid,.tpl.t5 .contact-wrap{grid-template-columns:1fr}.tpl.t5 .about-media{display:none}}",
  ...
  T.t6 = {
    ...
    css: "\
.tpl.t6{--blue:#0B4F7A;--blue2:#1877B8;--sky:#E9F2F8;--tx:#12212B;--mut:#5c6b74;--line:#dce6ec;font-family:'Inter',sans-serif;color:var(--tx);background:#fff}\
...
@media(max-width:820px){.tpl.t6 .hero-inner,.tpl.t6 .about-grid,.tpl.t6 .contact-wrap{grid-template-columns:1fr}.tpl.t6 .about-media{display:none}}",
  ...
  T.t7 = {
    ...
    fonts: ["Poppins:wght@400;500;600;700;800"],
    css: "\
.tpl.t7{--o1:#FF7A45;--o2:#FF4D8D;--am:#FFB65C;--cream:#FFF6EF;--tx:#2B1E1A;--mut:#7c6a63;--line:#F1E2D8;font-family:'Poppins',sans-serif;color:var(--tx);background:var(--cream)}\
...
@media(max-width:820px){.tpl.t7 .about-grid,.tpl.t7 .contact-wrap{grid-template-columns:1fr}.tpl.t7 .about-media{display:none}}",
  ...
  T.t8 = {
    ...
    fonts: ["IBM+Plex+Mono:wght@400;500;600", "IBM+Plex+Sans:wght@400;500;600;700"],
    css: "\
.tpl.t8{--bg:#0E1826;--pane:#132135;--cy:#4FD1C5;--tx:#D8E1EC;--mut:#7d8ba0;--line:#22344d;font-family:'IBM Plex Sans',sans-serif;color:var(--tx);background:var(--bg);background-image:linear-gradient(var(--line) 1px,transparent 1px),linear-gradient(90deg,var(--line) 1px,transparent 1px);background-size:44px 44px}\
...
.tpl.t8 .logo{height:36px}.tpl.t8[data-loginv='1'] .logo{filter:brightness(0) invert(1)}.tpl.t8 .logo-txt{font-family:'IBM Plex Mono',monospace;font-size:19px;font-weight:600;color:var(--cy)}\
.tpl.t8 .head-right{display:flex;gap:16px;align-items:center;font-family:'IBM Plex Mono',monospace;font-size:12px}.tpl.t8 .back{color:var(--mut)}.tpl.t8 .head-cta{border:1px solid var(--cy);color:var(--cy);padding:8px 16px}\
.tpl.t8 .hero{max-width:1200px;margin:0 auto;padding:clamp(50px,8vw,96px) clamp(20px,4vw,48px)}\
.tpl.t8 .hero-badge{font-family:'IBM Plex Mono',monospace;color:var(--cy);font-size:12.5px;letter-spacing:.05em;display:block;margin-bottom:20px}.tpl.t8 .hero-badge::before{content:'// '}\
...
.tpl.t8 .hero-tag{font-family:'IBM Plex Mono',monospace;font-size:14px;color:var(--mut);max-width:560px;margin:0 0 30px;line-height:1.7}\
...
.tpl.t8 .stat{padding:22px;border-right:1px solid var(--line)}.tpl.t8 .stat-n{font-family:'IBM Plex Mono',monospace;font-size:clamp(24px,3vw,34px);color:var(--cy);line-height:1}.tpl.t8 .stat-l{font-family:'IBM Plex Mono',monospace;font-size:11px;color:var(--mut);margin-top:8px}\
.tpl.t8 .sec{max-width:1200px;margin:0 auto;padding:clamp(50px,7vw,88px) clamp(20px,4vw,48px)}\
.tpl.t8 .eyebrow{font-family:'IBM Plex Mono',monospace;color:var(--cy);font-size:12.5px;margin-bottom:12px}.tpl.t8 .eyebrow::before{content:'┌ '}\
...
.tpl.t8 .svc{padding:28px 24px;border-right:1px solid var(--line);border-bottom:1px solid var(--line)}.tpl.t8 .svc-num{font-family:'IBM Plex Mono',monospace;color:var(--cy);margin-bottom:12px}.tpl.t8 .svc-num::before{content:'0x'}.tpl.t8 .svc-title{font-size:17px;font-weight:600;margin:0 0 8px}.tpl.t8 .svc-desc{font-size:13.5px;line-height:1.6;color:var(--mut);margin:0}\
.tpl.t8 .why-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:0;border:1px solid var(--line)}.tpl.t8 .why{padding:26px;border-right:1px solid var(--line);border-bottom:1px solid var(--line);background:var(--pane);display:flex;gap:14px}.tpl.t8 .why-num{font-family:'IBM Plex Mono',monospace;color:var(--cy)}.tpl.t8 .why-title{font-size:15px;margin:0 0 6px}.tpl.t8 .why-desc{font-size:13px;line-height:1.6;color:var(--mut);margin:0}\
.tpl.t8 .proc-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:24px}.tpl.t8 .proc{border-left:2px solid var(--cy);padding-left:18px}.tpl.t8 .proc-num{font-family:'IBM Plex Mono',monospace;color:var(--cy);font-size:28px;margin-bottom:8px}.tpl.t8 .proc-title{font-size:15px;margin:0 0 6px}.tpl.t8 .proc-desc{font-size:13px;line-height:1.6;color:var(--mut);margin:0}\
.tpl.t8 .proj-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(290px,1fr));gap:2px;border:1px solid var(--line);background:var(--line)}.tpl.t8 .proj{background:var(--bg)}.tpl.t8 .proj-imgwrap{position:relative;aspect-ratio:4/3;overflow:hidden}.tpl.t8 .proj-img{width:100%;height:100%;object-fit:cover}.tpl.t8 .proj-badge{position:absolute;top:10px;left:10px;font-family:'IBM Plex Mono',monospace;background:rgba(14,24,38,.8);border:1px solid var(--cy);color:var(--cy);font-size:10.5px;padding:3px 9px}.tpl.t8 .proj-body{padding:16px 18px}.tpl.t8 .proj-title{font-size:15.5px;font-weight:600;margin:0 0 5px}.tpl.t8 .proj-meta{font-family:'IBM Plex Mono',monospace;font-size:12px;color:var(--mut);margin:0}\
.tpl.t8 .style-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:18px}.tpl.t8 .style{border:1px solid var(--line);background:var(--pane);padding:24px}.tpl.t8 .style-num{font-family:'IBM Plex Mono',monospace;color:var(--cy);margin-bottom:8px}.tpl.t8 .style-name{font-size:17px;font-weight:600;margin:0 0 8px}.tpl.t8 .style-desc{font-size:13px;line-height:1.65;color:var(--mut);margin:0}\
...
.tpl.t8 .contact-lead{color:var(--mut);line-height:1.7;margin:0 0 24px}.tpl.t8 .c-label{font-family:'IBM Plex Mono',monospace;color:var(--cy);font-size:11px;margin-bottom:4px}.tpl.t8 .c-item{margin-bottom:16px}.tpl.t8 .c-phone a{font-family:'IBM Plex Mono',monospace;font-size:18px;color:var(--cy)}\
.tpl.t8 .c-social{display:flex;gap:16px;margin-top:20px;font-family:'IBM Plex Mono',monospace;color:var(--cy);font-size:12.5px}\
.tpl.t8 .contact-form{display:flex;flex-direction:column;gap:12px}.tpl.t8 .contact-form h3{font-size:18px;margin:0 0 6px}.tpl.t8 .contact-form input,.tpl.t8 .contact-form textarea{background:var(--bg);border:1px solid var(--line);color:var(--tx);padding:12px 14px;font-family:'IBM Plex Mono',monospace;font-size:13px}.tpl.t8 .contact-form button{background:var(--cy);color:#06251f;border:0;padding:14px;font-weight:600;cursor:pointer;font-family:'IBM Plex Mono',monospace}.tpl.t8 .ok{color:var(--cy);font-size:12.5px;font-family:'IBM Plex Mono',monospace}\
.tpl.t8 .site-foot{border-top:1px solid var(--line);padding:26px clamp(20px,4vw,48px);display:flex;justify-content:space-between;flex-wrap:wrap;gap:12px;font-family:'IBM Plex Mono',monospace;font-size:12px;color:var(--mut)}.tpl.t8 .foot-links a{color:var(--cy)}\
@media(max-width:820px){.tpl.t8 .about-grid,.tpl.t8 .contact-wrap{grid-template-columns:1fr}.tpl.t8 .about-media img{border-left:0;border-top:1px solid var(--line)}}",
  ...
  T.t9 = {
    ...
    css: "\
.tpl.t9{--bg:#F5F1EA;--pane:#fff;--tx:#2A2622;--mut:#7a7267;--acc:#9C6B3F;--line:#e4ddd0;font-family:'Inter',sans-serif;color:var(--tx);background:var(--bg)}\
...
.tpl.t9 .logo{height:40px}.tpl.t9[data-loginv='1'] .logo{filter:brightness(0)}.tpl.t9 .logo-txt{font-family:'Playfair Display',serif;font-size:25px;font-weight:600}\
...
.tpl.t9 .hero h1{font-family:'Playfair Display',serif;font-weight:600;font-size:clamp(38px,6.5vw,76px);line-height:1.08;margin:0 0 20px}\
...
.tpl.t9 .stat-n{font-family:'Playfair Display',serif;font-size:clamp(28px,3.6vw,44px);font-weight:600}.tpl.t9 .stat-l{font-size:11.5px;letter-spacing:.08em;text-transform:uppercase;color:var(--mut);margin-top:8px}\
...
.tpl.t9 .sec-title{font-family:'Playfair Display',serif;font-weight:600;font-size:clamp(28px,4vw,50px);margin:0 auto 42px;max-width:640px}\
...
.tpl.t9 .svc-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1px;background:var(--line);border:1px solid var(--line);text-align:left}.tpl.t9 .svc{background:var(--pane);padding:34px 28px}.tpl.t9 .svc-num{font-family:'Playfair Display',serif;color:var(--acc);font-size:26px;margin-bottom:14px}.tpl.t9 .svc-title{font-family:'Playfair Display',serif;font-size:21px;font-weight:600;margin:0 0 10px}.tpl.t9 .svc-desc{font-size:14px;line-height:1.7;color:var(--mut);margin:0}\
.tpl.t9 .why-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(270px,1fr));gap:34px 40px;text-align:left}.tpl.t9 .why{display:flex;gap:16px}.tpl.t9 .why-num{font-family:'Playfair Display',serif;color:var(--acc);font-size:32px}.tpl.t9 .why-title{font-size:16px;margin:0 0 6px}.tpl.t9 .why-desc{font-size:14px;line-height:1.7;color:var(--mut);margin:0}\
...
@media(max-width:820px){.tpl.t9 .about-grid,.tpl.t9 .contact-wrap{grid-template-columns:1fr}.tpl.t9 .about-media{display:none}}",
  ...
  T.t10 = {
    ...
    css: "\
.tpl.t10{--pur:#6C2BD9;--lime:#C6F135;--pink:#FF4FA3;--dark:#160B2E;--tx:#160B2E;--mut:#6b6480;--line:#e7e0f5;font-family:'Space Grotesk',sans-serif;color:var(--tx);background:#fff}\
